...
namespace WebApplication2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Apellidos,Empresa,Provincia,Municipio,Calle,Sector,Usuario,Contraseña,Estatus")] Clientes clientes)
        {
            if (id != clientes.Id)
            {
                return NotFound();
